...
public class DetectionResultController {
    ...
    public ResponseEntity<ApiResponse<DetectionResultResponse>> getDetailDetectionResult(@PathVariable String scanJobId) {
        DetectionResultResponse result = detectionResultService.getDetailDetectionResult(scanJobId);
